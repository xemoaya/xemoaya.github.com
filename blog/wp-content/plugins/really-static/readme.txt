...
Or ask the community at [Facebook](http://www.facebook.com/pages/really-static-Wordpress-Plugin/177723978808 "Facebook") or [here](http://blog.phpwelt.net/tag/really-static/ "my page")
...
= v0.4 (future) =
 * quicksetup for "noobs"
 * Hooks http://www.sorben.org/really-static/really-static-hooks.html
 * removed permalinkoption (now automatic)
 * 123 Quicksetup
 * reducing unnessesary refreshing of pages
 * ...
